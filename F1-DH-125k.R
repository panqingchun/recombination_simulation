##### The script is to simulate the genotype of 200 F1-DH materials, and evaluate the number of recombination event and the size of recombinant fragments.
...
write.table("F1-DH-125k-genotype.txt",col.names=T,row.names=F,sep="\t",quote=F) ###  the result file of genotype with 200 lines 
