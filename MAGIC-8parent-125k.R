...
F2_12<-cbind(lilinone(M1)[,1:3],lilinone(M2)[,3:4]) 
F2_34<-cbind(lilinone(M3)[,1:3],lilinone(M4)[,3:4]) 
F3_1234<-cbind(lilinone(F2_12)[,1:3],lilinone(F2_34)[,3:4]) 
F4_1234<-cbind(lilinone(F3_1234)[,1:3],lilinone(F3_1234)[,3:4]) 
F5_1234<-cbind(lilinone(F4_1234)[,1:3],lilinone(F4_1234)[,3:4])
F6_1234<-cbind(lilinone(F5_1234)[,1:3],lilinone(F5_1234)[,3:4])
F7_1234<-cbind(lilinone(F6_1234)[,1:3],lilinone(F6_1234)[,3:4])
F8_1234<-lilinone(F7_1234)
F8_1234
